...
% Figure macros - helper commands for consistent figure handling
% Internal helper for single-column figures (uses \centering like originals)
...
% Internal helper for single-column figures with padding
...
% Internal helper for two-column figures with optional padding
\newcommand{\ssawidefighelper}[6][]{%
  \begin{figure*}[#2]
    \begin{center}
    #1% optional \bigskip for padding
...
% Two-column figures - top placement
...
% Two-column figures - bottom placement
...
% Two-column figures - flexible placement
\newcommand{\mediumfig}[4][0.7]{\ssawidefighelper{bt}{#1}{#2}{#3}{#4}}
\newcommand{\mediumfigpad}[4][0.7]{\ssawidefighelper[\bigskip]{bt}{#1}{#2}{#3}{#4}}
...
% Special case: multiple images in one figure
