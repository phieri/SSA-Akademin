...
\newcommand\warningsymbol{%
  \tikz[baseline=-0.1ex]{
    \draw[very thick] (0,0) -- (0.4,0.7) -- (0.8,0) -- cycle;
...
% Definiera LaTeX som språk för listings-paketet
\lstdefinelanguage{LaTeX}{
  % Kommentarer
  comment=[l]{\%},
  morecomment=[s]{\%*}{*\%},
  % Nyckelord (vanliga LaTeX-kommandon)
  morekeywords={documentclass,usepackage,begin,end,section,subsection,
    subsubsection,chapter,part,paragraph,subparagraph,label,ref,
    cite,bibliography,bibliographystyle,item,includegraphics,caption,
    textbf,textit,texttt,emph,title,author,date,maketitle,tableofcontents,
    newcommand,renewcommand,newenvironment,renewenvironment,def,let,
    if,fi,else,ifx,ifnum,ifdim,newcounter,setcounter,addtocounter,
    value,arabic,roman,Roman,alph,Alph,fnsymbol,par,noindent,hspace,
    vspace,smallskip,medskip,bigskip,newpage,clearpage,linebreak,
    pagebreak,centering,raggedright,raggedleft,footnote,marginpar,
    textcolor,color,definecolor,fbox,framebox,makebox,parbox,minipage,
    rule,hrule,vrule,hfill,vfill,dotfill,appendix,input,include,
    setlength,addtolength,settowidth,settoheight,settodepth,
    newlength,the,makeatletter,makeatother,AtBeginDocument,AtEndDocument,
    RequirePackage,ProvidesPackage,PassOptionsToPackage,DeclareOption,
    ProcessOptions,NeedsTeXFormat,DeclareRobustCommand,ProvideCommand,
    CheckCommand,CommandName,newtheorem,theoremstyle,newdefinition,
    mathrm,mathbf,mathit,mathsf,mathtt,mathcal,mathbb,mathfrak,
    frac,sqrt,sum,int,prod,lim,sin,cos,tan,ln,log,exp,
    left,right,bigl,bigr,Bigl,Bigr,biggl,biggr,Biggl,Biggr,
    array,matrix,pmatrix,bmatrix,vmatrix,cases,align,equation,
    eqnarray,displaymath,displaystyle,textstyle,scriptstyle,
    scriptscriptstyle,limits,nolimits,overline,underline,overbrace,
    underbrace,stackrel,overset,underset,phantom,hphantom,vphantom,
    mediumfig,smallfig,largefig,qty,unit,SI},
  % Känslig för stora/små bokstäver
  sensitive=true,
  % Kommentarsstil
  commentstyle=\color{gray}\itshape,
  % Nyckelordsstil
  keywordstyle=\color{blue}\bfseries,
  % Strängstil (för matematiska uttryck mellan $ $)
  stringstyle=\color{red},
  % Identifierare som börjar med backslash
  alsoletter={\\,*},
  % Strängar definierade med $ för matematiskt läge
  morestring=[b]$,
  morestring=[b]",
  % Fånga miljöer som begin{...} och end{...}
  morekeywords=[2]{document,figure,table,equation,align,itemize,enumerate,
    description,verbatim,minipage,abstract,titlepage,thebibliography,
    center,flushleft,flushright,quote,quotation,verse,tabular,array,
    matrix,cases,split,multline,gather,flalign,displaymath,eqnarray,
    tikzpicture,tabularx,longtable,lstlisting,framed,shaded},
  keywordstyle=[2]\color{purple}\bfseries,
  % Paketnamn och klasser
  morekeywords=[3]{article,book,report,letter,beamer,memoir,
    graphicx,amsmath,amssymb,amsthm,hyperref,babel,inputenc,fontenc,
    geometry,fancyhdr,titlesec,tocloft,caption,subcaption,float,
    listings,xcolor,tikz,pgfplots,siunitx,biblatex,natbib,csquotes,
    multicol,multirow,booktabs,longtable,array,makeidx,glossaries},
...
\usepackage[ISBN=978-91-86368-32-6,SC3]{ean13isbn}
...
\newtcolorbox{exempelbox}{enhanced,enlarge left by=-1mm,leftrule=2mm,colback=white!95!black,colframe=black!50!white}
\newtcolorbox{historiabox}{enhanced,oversize=1mm,title=Historia,halign title=center}
...
% Helper for single-column figures with centering
\newcommand{\ssafighelper}[5]{
	\begin{figure}[#1]
		\centering
...
% Helper for single-column figures with padding
\newcommand{\ssafighelperpad}[5]{
	\begin{figure}[#1]
		\begin{center}
		\bigskip
		\includegraphics[width=#2\textwidth]{#3}
...
% Helper for two-column figures with center environment
\newcommand{\ssawidefighelper}[5]{
	\begin{figure*}[#1]
		\begin{center}
			\includegraphics[width=#2\textwidth]{#3}
			\caption{#4}
...
% Helper for two-column figures with padding
\newcommand{\ssawidefighelperpad}[5]{
	\begin{figure*}[#1]
		\begin{center}
		\bigskip
		\includegraphics[width=#2\textwidth]{#3}
...
% Figure macros using helpers
\newcommand{\smallfig}[4][0.4]{\ssafighelper{t}{#1}{#2}{#3}{#4}}
\newcommand{\smallbotfigtwo}[4][0.4]{\ssafighelper{bht}{#1}{#2}{#3}{#4}}
\newcommand{\smallfigpad}[4][0.4]{\ssafighelperpad{t}{#1}{#2}{#3}{#4}}
\newcommand{\tallfig}[4][0.4]{\ssafighelper{}{#1}{#2}{#3}{#4}}
\newcommand{\mediumfig}[4][0.7]{\ssawidefighelper{bt}{#1}{#2}{#3}{#4}}
\newcommand{\mediumfigpad}[4][0.7]{\ssawidefighelperpad{bt}{#1}{#2}{#3}{#4}}
\newcommand{\mediumbotfig}[4][0.7]{\ssawidefighelper{b}{#1}{#2}{#3}{#4}}
\newcommand{\mediumminusbotfig}[4][0.6]{\ssawidefighelper{b}{#1}{#2}{#3}{#4}}
\newcommand{\mediumtopfig}[4][0.7]{\ssawidefighelper{t}{#1}{#2}{#3}{#4}}
\newcommand{\mediumherefig}[4][0.7]{\ssawidefighelper{h!}{#1}{#2}{#3}{#4}}
\newcommand{\mediumminustopfig}[4][0.6]{\ssawidefighelper{t}{#1}{#2}{#3}{#4}}
\newcommand{\mediumplustopfig}[4][0.8]{\ssawidefighelper{t}{#1}{#2}{#3}{#4}}
\newcommand{\mediumplusbotfig}[4][0.8]{\ssawidefighelper{b}{#1}{#2}{#3}{#4}}
\newcommand{\pagefig}[4][0.7]{\ssawidefighelper{pbt}{#1}{#2}{#3}{#4}}
\newcommand{\largefig}[4][0.9]{\ssawidefighelper{}{#1}{#2}{#3}{#4}}
