...
\newcommand{\ssafighelper}[5]{\ssafloathelper{figure}{#1}{\centering}{#2}{#3}{#4}{#5}{\vspace{-10pt}}}
\newcommand{\ssafighelperpad}[5]{\ssafloathelper{figure}{#1}{\begin{center}\bigskip}{#2}{#3}{#4}{#5}{\vspace{-10pt}\end{center}}}
\newcommand{\ssawidefighelper}[5]{\ssafloathelper{figure*}{#1}{\centering}{#2}{#3}{#4}{#5}{}}
\newcommand{\ssawidefighelperpad}[5]{\ssafloathelper{figure*}{#1}{\begin{center}\bigskip}{#2}{#3}{#4}{#5}{\end{center}}}
