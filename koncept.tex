...
\def\@makechapterhead#1{%
  ...
  {\parindent \z@ \raggedright \normalfont
    \ifnum \c@secnumdepth >\m@ne
      \Huge\bfseries
      \fcolorbox{black}{black}{\color{white}\,\thechapter\,}~~
    \fi
    \interlinepenalty\@M
    \Huge\bfseries #1\par\nobreak
    \vskip 1cm
...
% Figure helper macros. Parameters: environment, placement, pre-block,
% width, image, caption, label, and post-block.
% The pre-block is used for layout adjustments (for example, additional
% vertical space before a padded figure), while the post-block is used for
% the final spacing after the caption.
\newcommand{\ssafloathelper}[8]{%
	\begin{#1}[#2]
		#3
...
\newcommand{\ssafighelper}[5]{%
	\ssafloathelper{figure}{#1}{\centering}{#2}{#3}{#4}{#5}{%
		\vspace{-10pt}}%
}
\newcommand{\ssafighelperpad}[5]{%
	\ssafloathelper{figure}{#1}{\centering\bigskip}{#2}{#3}{#4}{#5}{%
		\vspace{-10pt}}%
}
