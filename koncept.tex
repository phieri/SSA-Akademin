...
% Paketet ger stöd för att skapa grafer och diagram i LaTeX-dokument.
\usepackage{pgfplots}
...
% #1 = frekvens (för positionering), #2 = värde (för positionering),
% #3 = frekvens, #4 = värde och enhet
