...
\lstdefinelanguage{SPICE}{
  ...
  % Kommentarsstil (grå, kursiv)
  commentstyle=\color{gray}\itshape,
  % Nyckelordsstil för direktiv (blå, fet)
  keywordstyle=\color{blue}\bfseries,
  % Komponentprefix (grön, fet)
  keywordstyle=[2]\color{green!60!black}\bfseries,
  % Analyskommandon (lila, fet)
  keywordstyle=[3]\color{purple}\bfseries,
  % Strängar (används sällan i SPICE, men kan förekomma i .MODEL)
  stringstyle=\color{red},
  % Tillåt siffror och vissa specialtecken i identifierare
  alsoletter={.,_,-},
  % Literate för svenska tecken och specialtecken
  literate=
