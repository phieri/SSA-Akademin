...
### Ändrat
- Refaktorerat byggsystemet i Makefile för tydligare verktygsinställningar, mer robust skräpstädning och en PDF-byggkedja baserad på pdflatex/makeindex med dokumenterad byggprocess.
