...
Om spole och kondensator respektive resistor och kondensator i ett
...
Många moderna kvartskristaller kan uppvisa olastat Q-värde på \num{100000}.
...
Vid mycket hög frekvens kan spolens varvtal i en LC-krets ha minskat till
...
Ledarens längd tillsammans med kavitetens insida bildar spolen.
...
den seriella delen är gemensam (på bilden en spole).
...
Ett nät kan också vara T-format, som bild~\ssaref{fig:BildII3-33} visar, och
...
En spole är inte perfekt förlustfri, utan den har en parasitisk serieresistans.

För kondensatorer och spolar kommer resistansen att påverka deras Q-värde.
...
För mer om digitala filter se \ssaref{sec:DSP} samt \ssaref{digitala filter}.
