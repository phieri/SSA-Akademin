...
\label{kaennetecken_modulerade_signaler}
...
frekvenserna \qty{5}{\hertz}, \qty{15}{\hertz}, \qty{25}{\hertz}, \qty{35}{\hertz}
och så vidare.
...
En typisk sändning kan bestå av pulser med en längd av \qty{1}{\micro\second} och
en frekvens av \qty{1000}{\hertz}.
...
Om vi i till exempel 16QAM-koden i kapitel \ssaref{QAM} får in +0.2 i I och +1.1 i Q,
ser vi i tabell \ssaref{tab:16QAM} att närmaste symbolen är symbol 5 med +1 i I
