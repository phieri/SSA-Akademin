...
En amperemeter med valbar shuntresistor kan därför ha flera skalor.
...
Noggrannheten är sällan bättre än \qty{1,5}{\percent} av fullt utslag.
...
uteffekten beräknas enligt formlerna i avsnitt~\ssaref{mätaeffekt}.
...
Med en SVF-mätare som sätts in mellan effektkälla och ledning kan man
...
digitalt instrument.
Man kan också använda en så kallad absorptionsvågmeter, som är mycket enkel och
