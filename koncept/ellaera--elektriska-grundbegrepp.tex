...
Ta som exempel en kub av koppar med volymen \qty{1}{\cubic\centi\metre} och
vikten \(8,9\ gram\).
...
\emph{Lika laddningar stöter bort varandra -- olika
laddningar drar varandra till sig.}
...
Se även kapitel~\ssaref{ch:komponenter}.
...
Uttryckt på ett annat sätt är den algebraiska summan av spänningarna i en
...
Kapaciteten i en elektrisk cell uttrycks som produkten
av den ström \unit{\ampere} som cellen avger och under
den tid \(\mathrm{[s, h]}\) detta kan ske.
