\mediumtopfig{images/nomogram_db_effekt.png}{Nomogram för omvandling mellan effekt och decibel}{ellaera-nomogram-db-effekt}
...
\mediumfig{images/nomogram_db_spanning.png}{Nomogram för omvandling mellan spänning och decibel}{ellaera-nomogram-db-spaenning}
...
När beräkningen av förstärkning eller dämpning uttryckt i \unit{\decibel} görs med
...
\section[Sambandet spänning och dBm]{Sambandet mellan spaenning och dBm}
