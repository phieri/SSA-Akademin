...
induktorn ökat från noll till \qty{63}{\percent} av \(I_{\it max}\) och
spänningen över induktorn minskat till \qty{37}{\percent} av maxvärdet.
...
Energin i induktorn avleds genom resistorn som en ström med motsatt riktning än
vid inkopplingen.
