...
Spänningsdelning kan även utföras med kondensatorer och spolar förutsatt att
...
\subsection{Galvaniskt kopplade spolar}
\label{galvaniskt_kopplade_induktorer}

Induktansvärdet för galvaniskt sammankopplade spolar kan i princip
beräknas på samma sätt som för motsvarande sammankoppling av resistorer.

\subsubsection{Galvaniskt seriekopplade spolar}
\harecsection{\harec{a}{3.1.1c}{3.1.1c}}
\index{spole!seriekopplade}
\index{seriekoppling!spolar}

Förutsatt att magnetfälten från de respektive spolarna inte återverkar på
...
\subsubsection{Galvaniskt parallellkopplade spolar}
\harecsection{\harec{a}{3.1.1d}{3.1.1d}}
\index{spole!parallellkopplade}
\index{parallellkoppling!spolar}
...
\subsection{Magnetiskt kopplade spolar}
\index{spole!magnetiskt kopplade}
\index{magnetisk koppling!spolar}
\index{ömsesidig induktans}

\smallfig[0.35]{images/cropped_pdfs/bild_2_3-07.pdf}{Magnetiskt kopplade spolar}{fig:BildII3-07}

I praktiken anordnas ofta spolar så, att deras respektive magnetfält kan
återverka på varandra -- så kallad magnetisk koppling.

En \emph{ömsesidig induktans} \(M\) uppstår i spolarna på grund av denna
koppling.
Den ömsesidiga induktansen ökar eller minskar det resulterande induktansvärdet
beroende på om spolarnas magnetfält verkar med eller mot varandra.

Beräkningen av värdet på \(M\) är emellertid relativt komplicerad och behandlas
ej här.
I stället görs en förenklad framställning.

Bild~\ssaref{fig:BildII3-07} visar seriekopplade spolar, vars magnetfält
kopplar till varandra på olika sätt.
''Pricken'' vid änden av spolarna på bilden markerar magnetfältens inbördes
polarisering.

\subsubsection{Magnetiskt kopplade spolar i serie}
...
%
\begin{exempelbox}
Två spolar har en induktans av 20 respektive \qty{10}{\micro\henry} och en
ömsesidig induktans av \qty{2}{\micro\henry}.
Spolarna är kopplade och placerade så att deras magnetfält samverkar.
...
Två spolar har en induktans av 20 respektive \qty{10}{\micro\henry} och en
ömsesidig induktans av \qty{2}{\micro\henry}.
Spolarna är kopplade och placerade så att deras magnetfält motverkar varandra.
...
\subsubsection{Magnetiskt kopplade spolar i parallell}
När flera spolar är parallellkopplade och placerade så att deras magnetiska
fält interagerar behöver man ta hänsyn till om de samverkar eller motverkar varandra.
Mer läsning om spolar och hur de påverkar varandra finns att läsa i
\cite{letrafo}.

\textbf{Formler:}

Samverkande parallella spolar
%
\[L = \frac{L_1 \cdot L_2 - M^2}{L_1 + L_2 - 2M}\]
%
Motverkande parallella spolar
%
\[L = \frac{L_1 \cdot L_2 - M^2}{L_1 + L_2 + 2M}\]
%
...
\subsection{In- och urkoppling av en spole}

\subsubsection{Inkoppling}

\tallfig{images/cropped_pdfs/bild_2_3-10.pdf}{Inkoppling av en spole}{fig:BildII3-10}

Bild~\ssaref{fig:BildII3-10} visar inkopplingen av en spole.
En spole L i serie med en resistans R kopplas in över en likspänning U.
Spänningen över spolen minskar från \(U_{\it max}\) till 0.

Strömmen genom spolen ökar efter inkopplingen exponentiellt från 0 till \(I_{\it max}\)
%
...
spolen ökat från noll till \qty{63}{\percent} av \(I_{\it max}\) och
spänningen över spolen minskat till \qty{37}{\percent} av maxvärdet.


\subsubsection{Urkoppling}
\label{induktor_urkoppling}

Spänningskällan kopplas bort från samma spole som ovan.
En resistor är inkopplad över spolen.
Energin i spolen avleds genom resistorn som en ström med motsatt riktning än
vid inkopplingen.
Strömmen är vid urkopplingstillfället \(I_{\it max} = i_L\) och minskar därefter
exponentiellt
...
%  \raggedright
  \(i_L\) är strömmen genom spolen efter en given ur\-kop\-p\-li\-ngs\-tid, 
...
spolen minskat till \qty{37}{\percent} av maxvärdet.
...
All den energi som lagras i en spole finns i dess magnetfält.
När strömmen bryts eller minskas så återgår energin omedelbart till kretsen.
I en spole kan det således inte finnas någon kvarstående energi, vilket
det däremot kan göra i en kondensator.

Under den tid som magnetfältet i en spole avvecklas eller byggs upp, så
induceras en motspänning i den.
Denna spänning är högre än den som finns över spolen innan strömmen bryts
eller ändras och är proportionell mot den hastighet som ändringen har.
När en strömkrets med spole bryts är det vanligt att det i brytögonblicket
...
Kondensatorn fångar upp en del av energin i spolen och resistorn minskar
hastighetsändringen.
...
svängningskretsar) bestående av kondensatorer och spolar, som är kopplade i
...
\textbf{Fall b:} Förloppen med en spole L.

I en spole är utvecklingen av ström och spänning inte samtidig.
Vid inkopplingen stiger spänningen genast till maxvärdet medan strömmen stiger
långsammare och bygger under tiden upp ett magnetfält i spolen och omkring
...
En växelström genom en ideal spole är förskjuten \ang{90} \emph{efter}
spänningen.
...
Effekt överförs från strömkällan till spolen när ström och spänning har
samma riktning.
När ström och spänning har olika riktning försöker spolen i stället
''ladda'' strömkällan med energi från sitt kraftfält.
Effekt pendlar mellan strömkällan och spolen, varvid effekten i
ena riktningen är lika stor som i andra riktningen.

Sett över en hel period upphäver därför dessa effekter varandra.
Följden blir att en ideal spole, i motsats till en resistor, inte förbrukar
någon aktiv effekt.
Man säger att en reaktans, här en spole, arbetar med reaktiv effekt.
...
Liksom med en spole överförs effekt från strömkällan till kondensatorn när
...
Men när strömmen genom en ledare eller spole, liksom spänningen över en
...
reaktansen i en spole eller kondensator uppträder annorlunda i tiden vid
...
Strömmen \(I_L\) genom spolen är fasförskjuten \ang{90} efter \(U\) och
ritas rakt nedåt.
...
Spänningen över reaktansen \(X_L\) (spolen) ligger \ang{90} före \(I\) och
ritas rakt uppåt.
\end{description}
...
kondensator och en spole med förskjutbar järnkärna.
...
\]
%
Energiförluster uppstår både i kretsens kondensator och spole, men moderna
kondensatorer har så låga förluster att spolen ensam kan anses bestämma
