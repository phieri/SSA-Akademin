...
En komponent som uppvisar induktans kallas i dagligt tal för \emph{spole}
(eng. \emph{coil}), \emph{induktor} (eng. \emph{inductor}) eller
\emph{induktansspole}.
Dessa termer används ofta synonymt i praktiken.
En \emph{drossel} (eng. \emph{choke}) är en speciell typ av spole med uppgift
att begränsa växelström.
I denna bok använder vi genomgående termen \emph{spole} för komponenten som
uppvisar induktans, men läsaren bör känna till att andra termer också
...
När det uppstår självinduktion i en ledare kan ledaren uppvisa induktans.
...
Hela komponenten kallas då för spole.
...
magneten förs fram och tillbaka genom spolen.

Instrumentet ger utslag när magneten är i rörelse.
Utslaget blir större vid snabbare hastighetsändring.
Utslagsriktningen växlar när magneten förs in i respektive dras ut ur spolen
-- det uppstår en växelström.

En växelspänning uppstår över spolen även när den ingår i en strömkrets som
sluts och bryts -- alltså utan en magnet som rör sig.

\paragraph{Försök 2:}
I bild~\ssaref{fig:BildII2-3b} har permanentmagneten bytts mot ännu en
spole.
Utöver den första spolen, som vi nu kallar sekundärlindning, kallar vi den
nya spolen för primärlindning.
...
\mediumfig{images/cropped_pdfs/bild_2_2-04.pdf}{Schemasymboler för spolar}{fig:BildII2-4}

\subsection{Olika utföranden}
\index{drossel}

Bild~\ssaref{fig:BildII2-4} visar schemasymboler för ett antal vanliga spolar.
Utöver dessa finns elektromagneter, drosslar, spolar för resonanskretsar,
...
1~henry (\qty{1}{\henry}) är självinduktionen i en spole som alstrar en
...
Induktansen beror på spolens mekaniska dimensioner, antalet lindningsvarv och
materialet i kärnan.

Induktansen i en cylindrisk spole är proportionell mot tvärsnittsytan, omvänt
proportionell mot längden och proportionell mot kvadraten på lindningsvarvtalet.

Induktansen ökar om spolen förses med en kärna av järn och minskar med en
kärna av omagnetisk, ledande metall, till exempel koppar, mässing eller
aluminium.

Precis som för kondensatorn har materialet i en spoles kärna betydelse,
...
strömökningen i en spole fördröjd. Orsaken är att en spole inte bara har
...
länge som strömmen genom spolen ändras.
En spole gör således också motstånd mot varje strömändring och detta motstånd
...
Den \emph{Induktiva reaktansen \(X_L\)} -- växelströmsmotståndet i en spole
...
spolens induktansvärde.
Inga förluster uppstår i en ideal spole, det vill säga en spole som
...
\subsection{Fasförskjutning mellan spänning och ström i en spole}
\harecsection{\harec{a}{2.3.5}{2.3.5}}
\index{spole!fasförskjutning}

Med fasförskjutning menas den tidsmässiga förskjutningen mellan ström- och
spänningsförlopp.
Strömmen genom en spole når inte sitt toppvärde samtidigt
som spänningen över den.
Orsaken är växlingarna mellan elektrisk och magnetisk energi i spolen.
Detta illustreras i bild~\ssaref{fig:BildII3-11}.

I en ideal spole är spänningen fasförskjuten \ang{90} före strömmen.
I praktiken är dock förskjutningen något mindre än \ang{90} på grund av
resistansen i spolen.

\subsection{Q-faktor -- godhetstal}
\harecsection{\harec{a}{2.3.6}{2.3.6}}
\index{Q-faktor!spole}
...
Q-faktorn för en spole är kvoten av dess reaktans och dess serieresistans.
...
Därför är spolarna i sändarslutsteg ofta försilvrade och består av rör med
...
temperaturkoefficienten i den frekvensbestämmande spolen i en oscillatorkrets
påverkar frekvensstabiliteten.

Eftersom metallen koppar utvidgar sig vid temperaturökning och spolens
...
Spolar kan innehålla kärnor av någon metallegering vars egenskaper också är
temperaturberoende.

I praktiken kan man knappast påverka temperaturkoefficienten i en spole.
Eftersom en resonanskrets för det mesta även innehåller kondensatorer kan
man kompensera en positiv temperaturkoefficient i spolen med en negativ
