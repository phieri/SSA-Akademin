...
\label{saendare_frekvensblandning}
...
Bild \ssaref{fig:bildII5-7} visar en PLL-styrd rak sändare med en
...
Den önskade sändningsfrekvensen fås genom att blanda \qty{70}{\mega\hertz} MF med
