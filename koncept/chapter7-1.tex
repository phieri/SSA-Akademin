...
Det första värdet kan passa för en \qty{2}{\milli\metre} tjock halvvågsantenn för
\qty{7}{\mega\hertz}.
...
Frekvensen för grundresonansen är cirka \qty{3,5}{\mega\hertz}, men den är även i
resonans på de harmoniska övertonerna (7, 14, 21, \qty{28}{\mega\hertz} osv.).
