...
\subsection{Ståendevågmätare (SVF-mätare)}
\harecsection{\harec{a}{8.2.1.3}{8.2.1.3}}
\index{ståendevågmätare}
\index{SVF-mätare}
\index{SWR-meter|see {ståendevågmätare}}
...
\mediumfig{images/cropped_pdfs/bild_2_8-09.pdf}{SVF-mätare, princip och inkoppling}{fig:bildII8-9}
...
Denna reflekterade energi kan mätas med en \emph{ståendevågmätare}
...
Användningsområden för SVF-mätare är:
...
SVF-mätaren är ett av de mest användbara instrumenten vid HF-mätningar.
En SVF-mätare kan ha separata instrument för fram- respektive backeffekt eller
ett gemensamt.

SVF-mätaren kan vara ständigt inkopplad till exempel mellan sändare och antenn,
men ska då kunna tåla effektutvecklingen.
En SVF-mätare kan alstra övertoner, vilka kan medföra störningar.
...
Det kan emellanåt finnas en inbyggd lågfrekvensgenerator, där man kan ställa in
