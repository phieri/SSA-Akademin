...
\index{oscillator!superheterodyn-VFO}
...
En VFO, vars frekvens kan styras med en likspänning, kallas \emph{spänningsstyrd
...
Varje avvikelse från referensfrekvensen kommer att medföra justering av
VCO-frekvensen.
...
förstärkare och bör därför ha låg utgångsimpedans.
...
Oscillatorn bör monteras så långt bort som möjligt från övriga värmealstrande
komponenter.
