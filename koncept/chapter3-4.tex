...
\subsection{Allmänt}
\label{foerstaerkarsteg_allmaent}
...
Bild \ssaref{fig:BildII3-41} visar principen för förstärkare med både elektronrör
och transistor.
...
\label{foerstoerkare_grundkoppling}
...
Klass B (bild \ssaref{fig:BildII3-45}) är ett olinjärt arbetssätt med en låg viloström i förhållande
...
\label{foerstaerkare_utstyrningskontroll}
