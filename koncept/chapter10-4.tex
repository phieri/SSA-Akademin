...
längden \(\lambda/2\) och vara ''öppen''.  Bild~\ssaref{fig:bildII9-4} visar exempel
...
Bild \ssaref{fig:bildII9-10b} och \ref{fig:bildII9-10a} visar några sätt att
...
Se även kapitel \ssaref{elektriskafält}, \ref{elektromagnetiskafält} och
\ssaref{jordning}.
