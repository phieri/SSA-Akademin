...
I rymden breder radiovågor ut sig mycket långt.
Det uppstår dock även där utbredningsförluster i materia som finns i vägen.
...
\begin{itemize}
  ...
  hastighet som är cirka \qty{300000}{\kilo\metre\per\second} (se även avsnitt
  \ssaref{ljushastigheten})
...
\harecsection{\harec{a}{7.11}{7.11}} %
...
%% k7per: I don't think we should use colon before a set of sections?
