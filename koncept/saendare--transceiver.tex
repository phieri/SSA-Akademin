...
En station sägs sända \emph{duplex} eller \emph{full duplex} när den kan
...
Den PLL-styrda sändare som redan beskrivits i bild~\ssaref{fig:bildII5-7} har
...
delningstal vid sändning respektive mottagning, se tabell~\ssaref{tab:delningstal}.
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\caption{Exempel på användning av olika delningstal vid simplex- och repeaterkanaler.}
