...
\begin{lstlisting}[language=SPICE,caption={Källkod för spänningsdelare},label=lst:voltage-divider]
...
\begin{lstlisting}[language=SPICE,caption={Källkod för RC-lågpassfilter},label=lst:rc-lowpass]
