...
högsta frekvenskomponenten i basbandet.
...
sidbanden mycket överstiga den högsta frekvenskomponenten i basbandssignalen.

\emph{Använd bandbredd} (eng. \emph{occupied bandwidth}) är frekvensavståndet
mellan den övre och den undre gränsfrekvensen i ett spektrum, där
medeleffekten understiger 0,5~\% (\qty{-23}{\decibel}) av den totala
medeleffekten.
För amatörer är det inte alltid lätt att bestämma den använda bandbredden.
Den kan mätas med en spektrumanalysator, men ett sådant instrument är
svårtillgängligt för de flesta amatörer.
Den använda bandbredden kan även beräknas, men det kräver matematikkunskaper i
...
finns i kapitel~\ssaref{ch:modulation}.
...
Sändningsklass anges med tre tecken där
