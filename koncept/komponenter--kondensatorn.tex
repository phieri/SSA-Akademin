...
inverkan.
Då behövs i stället särskilda anordningar för att ta upp eller avge energi på
...
%%
\formel{C = \varepsilon_0 \cdot \varepsilon_r \dfrac{A}{d}}{
	C\ [\unit{\farad}] \\
	A\ [\unit{\metre\squared}] \\
	d\ [\unit{\metre}] \\
	\varepsilon\ [\unit{\farad\per\metre}]
}
...
Använd för säkerhets skull låg spänning exempelvis från en
...
%%
\formel{X_C = \dfrac{1}{2\pi fC}\quad \text{eller}\quad X_C = \dfrac{1}{\omega C}}{
	X_C\ [\unit{\ohm}] \\
	f\ [\unit{\hertz}] \\
	C\ [\unit{\farad}]
}
...
Med sitt extremt tunna dielektrikum har elektrolytkondensatorn en mycket högre
kapacitans än andra sorters kondensatorer, men den har också några nackdelar.
...
\noindent
Elektrolytkondensatorer har särskilt högt kapacitansvärde.
Till skillnad från andra kondensatortyper är elektrolytkondensatorer
polariserade.
Utom i ett specialfall innebär det att polariteten på den pålagda spänningen
inte får kastas om.
