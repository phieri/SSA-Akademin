...
Jämför detta med en induktor (spole) där reaktansen
är proportionell mot frekvensen.
...
Temperaturkoefficienten \(\alpha _c\) anger
kapacitansändringen per grad temperaturändring.
