...
\textbf{Exempel:} En krets med strömkälla, lampa,
...
Resistansen mellan två punkter i en strömkrets är 1~ohm som även skrivs
...
\noindent
\textbf{Not.} \emph{Förväxla inte A [tvärsnittsytan]
i denna formel med enheten ampere.}
\end{exempelbox}
...
\subsubsection{Ljusberoende resistor, fotoresistor --
...
Färgkoden består av tre olika scheman, det kan finnas 4, 5 eller 6 band runt
komponenten.
De första banden ger värdet hos komponenten och de två sista banden har särskild
