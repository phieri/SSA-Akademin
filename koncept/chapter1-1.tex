...
Måttenheten för ström är \emph{ampere} \(\mathrm{A}\) \cite{SIbrochure9}.
...
Resistans uttrycks i enheten \emph{ohm} \cite{SIbrochure9} och betecknas med
...
\cite{SIbrochure9} i stället för \emph{voltampere} \(\mathrm{[VA]}\).
...
\(\mathrm{[J]}\) \cite{SIbrochure9} och anges med symbolen \(W\) för Work.
