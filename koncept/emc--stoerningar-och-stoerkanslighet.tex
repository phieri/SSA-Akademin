...
\emph{SFS 1992:1512}~\cite{SFS1992:1512}
...
\index{hembyggd radiosändare}
\index{radioutrustningslagen}
\index{CE-märkning}

Enligt \emph{radioutrustningslagen} SFS~2016:392~\cite{SFS2016:392} ska
radioutrustning som släpps ut eller tillhandahålls på marknaden inom EU vara
...
har inte varit uppfyllda. Läs mer om EMC i avsnitt~\ssaref{EMC-lagen}.
...
avsnitt~\ssaref{hembyggd elektronik}.
...
Post- och telestyrelsens föreskrifter om undantag från tillståndsplikt för
användning av vissa radiosändare 3~kap. 14~\S{}
\emph{De tekniska egenskaperna hos
