...
Bild~\ssaref{fig:bildII6-23} visar en \(\lambda/2\)-dipol för 80~m-bandet som
...
Den kommer att likna en stege i det ursprungliga utförandet på en matarledning.
...
impedans \(Z\), också kallat vågmotstånd, som är oberoende av ledningens längd.
...
\index{ståendevågförhållande}
\index{SVF|see {ståendevågförhållande}}
\index{transmissionsledning!SVF}

(se även avsnitt~\ssaref{SVF} om Standing Wave Ratio).
...
SVF-mätare visar beroende på var den kopplas in i kedjan sändare -- ledning --
...
I tabell~\ssaref{tab:kabeldaempning} visas kabeldämpningen, effektförlusten, i
...
Balansering kan även göras med ett koaxialkabelarrangemang, som i
...
Bild~\ssaref{fig:bildII6-33} visar förloppet i en öppen $\lambda/4$
...
\item Vid tvära bockar på ledningen kan det uppstå oönskad
