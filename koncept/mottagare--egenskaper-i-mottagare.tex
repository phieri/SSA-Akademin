...
Moderna mottagare medger att flytta både övre och undre gräns för att
...
\emph{ugnskompenserad} (\emph{OCXO}) kristalloscillator för att få en högre
...
\begin{exempelbox}
I bild~\ssaref{fig:bildII4-22} ska en sändning på \qty{3600}{\kilo\hertz} tas
...
de frekvenser där signalamplituden dämpats till \qty{70}{\percent} av
toppvärdet.
