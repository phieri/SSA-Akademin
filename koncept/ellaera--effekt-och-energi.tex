...
Det vill säga vid ökning fördubblas effekten för var 3:e \unit{\decibel} och vid
minskning halveras effekten för var 3:e \unit{\decibel}.
...
logaritmiskt i B eller \unit{\decibel}
...
Förhållandet mellan spänningar kan uttryckas i \unit{\decibel} på ett liknande
sätt som med strömmar.
...
\begin{center}
\begin{tabular}{rlrlrl}
\qty{0}{\decibel}  & = 1    & \qty{1}{\decibel}  & = 1,12 & \qty{2}{\decibel}  & = 1,25 \\
\qty{3}{\decibel}  & = 1,4  & \qty{4}{\decibel}  & = 1,6  & \qty{5}{\decibel}  & = 1,8  \\
\qty{6}{\decibel}  & = 2    & \qty{7}{\decibel}  & = 2,24 & \qty{8}{\decibel}  & = 2,5  \\
\qty{9}{\decibel}  & = 2,8  & \qty{10}{\decibel} & = 3,2  & \qty{11}{\decibel} & = 3,6
\end{tabular}
\end{center}
...
\(I_{\text{hög}}/I_{\text{låg}}\) & Analys             & Skriv            & \unit{\decibel} \\
  \hline
