...
\begin{table*}[b]
  \vspace{10ex}
    ...
    S-Meter  & \multicolumn{3}{c|}{Under \qty{30}{\mega\hertz}} & \multicolumn{3}{c}{Över \qty{30}{\mega\hertz}} \\
    värde    & \multicolumn{1}{c}{dBm} & \multicolumn{1}{c}{(\unit{\micro V} vid \qty{50}{\ohm})} & \multicolumn{1}{c|}{\unit{dB\micro V}} & \multicolumn{1}{c}{dBm} & \multicolumn{1}{c}{(\unit{\micro V} vid \qty{50}{\ohm})} & \multicolumn{1}{c}{\unit{dB\micro V}} \\
    \hline
  ...
  \end{tabular}
  \caption{Tabell över S-värden, spänningar och effekter}
\end{table*}
...
Signalspänningen mäts över en impedans av \qty{50}{\ohm}.

Eftersom S-enheten är logaritmisk, så motsvarar till exempel signalstyrkan S8
halva signalspänningen, det vill säga \qty{25}{\micro\volt} eller
\qty{-6}{\decibel} jämfört med S9.
...
I kortvågsområdet (under \qty{30}{\mega\hertz}) uppträder ett atmosfäriskt
...
Över \qty{30}{\mega\hertz} däremot, är det mest mottagarens interna brus som
...
S-skala över \qty{30}{\mega\hertz}.
...
av \qty{10}{\milli\second} \(\pm\)\qty{0,2}{\milli\second} och en falltid av
\qty{500}{\milli\second}.
