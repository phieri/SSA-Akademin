...
Vi kallar varje sådant fel för ett \emph{bitfel} (eng. \emph{bit error}).
...
Sannolikheten att man tolkar en signal som varande på ena eller andra sidan av en
gräns beror på hur långt bort från medelvärdet den gränsen, ofta benämnd
kvantiseringsgränsen, är i förhållande till det effektiva värdet (eng.
