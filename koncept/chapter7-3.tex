...
\subsection{Omvikt dipol}
\harecsection{\harec{a}{6.1.3}{6.1.3}}
\index{omvikt dipol}
\index{folded dipole}

Bild~\ssaref{fig:bildII6-12} visar en omvikt dipol (eng. \emph{folded dipole})
som kan ses som två eller flera parallella element, som är sammankopplade i
ändarna.
...
\smallfig{images/cropped_pdfs/bild_2_6-13.pdf}{GP-antenn (jordplanantenn) med vertikal strålare och radialer}{fig:bildII6-13}
