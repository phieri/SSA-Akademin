...
inte använder extern energi för sin funktion, och dels aktiva filter vilka i princip
...
\formel{f_g = \dfrac{1}{2\pi \sqrt{LC}}}{
	f_g\ [\unit{\hertz}] \\
	L\ [\unit{\henry}] \\
	C\ [\unit{\farad}]
}
