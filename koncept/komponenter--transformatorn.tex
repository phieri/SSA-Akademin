...
Den så kallade kopplingsfaktorn mellan lindningarna
...
%%
det vill säga att spänningen över lindningarna är
proportionell mot lindningsvarvtalen.
...
spänningen \qty{400}{\volt}/\qty{230}{\volt} används i lokala distributionsnät, det vill säga
