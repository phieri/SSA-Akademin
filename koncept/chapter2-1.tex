...
\qty{1}{\ohm} (uttalas ''en åm''), när spänningen \qty{1}{\volt} mellan punkterna
gör att en ström av \qty{1}{\ampere} (en ampere) flyter i kretsen.
...
\ssaref{table:metaller} finns ett antal vanliga metallers resitivitet
angivna.
...
\label{fasta_resistorer_linjaera}
...
\label{fasta_resistorer_olinjaera}
