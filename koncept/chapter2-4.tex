...
\label{transformator}
\label{primaerlindning}
\label{transformator!primaerlindning}
\label{sekundaerlindning}
\label{transformator!sekundaerlindning}
...
varandra, vilket visas i bild \ssaref{fig:BildII2-8}. Särskild försiktighet ska därför 
...
Sekundärspänningen i en klenspänningstransformator, bild \ssaref{fig:BildII2-11},
