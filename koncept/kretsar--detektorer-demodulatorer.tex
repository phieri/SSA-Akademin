...
Några blandningsprodukter faller ut på LF-nivå.
...
För varje positiv halvvåg levererar den monostabila vippan en impuls av konstant
längd.
Tidsavstånden mellan pulserna kommer att vara proportionella mot FM-signalens
frekvens.
...
Den frekvensmodulerade MF-signalen och en VCO-signal matas in i en fasjämförare.
