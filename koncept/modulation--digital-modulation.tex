...
\index{FSK|see {frekvensskiftsmodulation}}
\index{frekvensmodulation}
\index{GFSK|see{Gaussian Frequency Shift Keying}}
...
\index{binär fasskift modulation}
\index{BPSK|see{binär fasskift modulation}}
...
\index{QAM|see{kvadraturamplitudmodulation}}
\index{16QAM}
\index{DAB}
\index{DVB-T2}
\index{Wi-Fi}
