...
\index{FET|see{fälteffekttransistor}}
...
\index{MOSFET|see{Metal Oxide Semiconductor Field Effect Transistor}}
\index{transistor!MOSFET}

Bild~\ssaref{fig:BildII2-22} visar skikten i en N-kanal MOSFET.

I en MOSFET (eng. \emph{Metal Oxide Semiconductor Field Effect Transistor}) är
