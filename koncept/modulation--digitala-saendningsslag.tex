...
in- och utgång för dess ljudkort är kopplade till amatörradioutrustningen.
...
Med nyare amatörradiotransceivrar blev det senare den vanligast förekommande
...
\qty{1,25}{\kilo\hertz}.
Bärvågorna ligger med \qty{75}{\hertz} mellanrum och varje bärvåg moduleras med
