...
\qty{0,000001}{\volt}. I slutsteget i en amatörradiosändare kan
anodspänningen vara högre än \qty{2000}{\volt} och uteffekten upp till
\qty{1000}{\watt}. I spektrum för elektromagnetiska vågor finns mycket
höga frekvenser så som \qty{10000000000}{\hertz}.
...
används som exempel prefix tillsammans med enheterna \unit{\hertz},
\unit{\watt}, \unit{\volt}, \unit{\farad} etc. som exempel.
...
%      10 & & = \(1 \cdot 10^1\) & & (\unit{deka\noop} uttalas deka) \\
%      1 & \unit{\volt} &  = \(1 \cdot 10^0\) V & \qty{1}{\volt} & (\(1 = 10^0\) är grundenhet) \\
%      0,1 & \unit{\meter} & = \(1 \cdot 10^{-1}\) & \qty{1}{\deci\meter}    & (\unit{\deci\noop} uttalas deci) \\
%      0,01 & \unit{\meter} & = \(1 \cdot 10^{-2}\) & \qty{1}{\centi\meter} & (\unit{\centi\noop} uttalas centi) \\
