...
\qty{50}{\hertz}.
Nätspänningen för hushållsändamål är numera \qty{400}{\volt}/\qty{230}{\volt}.
...
\emph{Likriktning} (eng. \emph{rectification}) av spänningar och strömmar i en
...
Exempel på sådana kallas drop-omvandlare, som kan användas för att sänka
spänningen.
