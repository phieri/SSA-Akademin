...
blandningsprodukten har frekvensen \qty{9,2}{\kilo\hertz} och den dämpas kraftigt
av lågpassfiltret.
...
Vid SSB-mottagning måste naturligtvis hela LF-området upp till \qty{3000}{\hertz}
