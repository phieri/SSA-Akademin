...
\index{ITU|see {Internationella teleunionen}}
\index{ITU RR}
\index{ITU Radioreglemente (ITU RR)}
\index{RR}
\index{radioreglemente}
\index{Post- och telestyrelsen (PTS)}
\index{PTS|see {Post- och telestyrelsen}}
...
en amatörstation medan denna person befinner sig på tillfälligt besök i landet,
...
\emph{ Det innebär att tilldelning, fördelning och anvisning av frekvenser
  ...
  Skillnaderna förklaras till exempel av regionalt
  olika behovsstruktur, befolkning
  etc.}
...
\emph{Det förekommer också likheter.
  ...
  Till exempel behöver särskild hänsyn tas vid
  frekvenstilldelning (allokering) till
