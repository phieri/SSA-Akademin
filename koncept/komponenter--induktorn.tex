...
\index{EMK|see {elektromotorisk kraft}}
\index{induktor}
...
\emph{relativa permeabiliteten} \(\mu_r\) som ges av
%%
\[\mu = \mu_0\mu_r\]
%%
...
Resistansen för en viss ledare blir alltså större
för växelström än för likström.
