...
\ssaref{bandplaner} samt bilaga \ref{svensk frekvensplan} svensk frekvensplan och
bilaga \ssaref{svenska repeatrar} frekvenser för svenska amatörradiorepeatrar.)
...
\subsection{\qty{5650}{\mega\hertz} bandplan}
...
\subsection{\qty{47}{\giga\hertz} bandplan}
\label{47GHzbandplan}
Denna bandplan baseras på IARU Region~1 2014 \cite{IARU1}.
